...
from torchview.computation_node import ModuleNode, FunctionNode, TensorNode, NodeContainer
from torchview.computation_graph import ComputationGraph
...
class RecorderTensor(torch.Tensor):
    ...
    def __init__(
        self, x: Any, tensor_node: Union[TensorNode, list[TensorNode]] #TensorNode | list[TensorNode]
    ):
        # pylint: disable=unused-argument
    ...
    def __torch_function__(
        cls: Any, func: Union[Callable[..., Any], ScriptMethod],
        types: Any,
        args: Any = (),
        kwargs: Any = None,
    ) -> Any:
...
def attach_node(
    kwargs: dict[str, Any],
    tensor_to_node: Union[dict[RecorderTensor, TensorNode], None] = None
) -> Callable[..., Any]:
